...
GLint getProgramLogLength(QOpenGLFunctions_2_1* f, GLuint obj) {
    GLint infologLength = 0;
    f->glGetProgramiv(obj, GL_INFO_LOG_LENGTH, &infologLength);
    return infologLength;
}

GLint getShaderLogLength(QOpenGLFunctions_2_1* f, GLuint obj) {
    GLint infologLength = 0;
    f->glGetShaderiv(obj, GL_INFO_LOG_LENGTH, &infologLength);
    return infologLength;
}

std::vector<GLchar> getShaderInfoLogAsVector(QOpenGLFunctions_2_1* f, GLuint obj) {
...
QString getShaderInfoLogAsQString(QOpenGLFunctions_2_1* f, GLuint obj) {
...
std::vector<GLchar> getProgramInfoLogAsVector(QOpenGLFunctions_2_1* f, GLuint obj) {
...
QString getProgramInfoLogAsQString(QOpenGLFunctions_2_1* f, GLuint obj) {
...
GLuint compileShaders(QOpenGLFunctions_2_1* f, const char* vertexShaderSrc, GLint vertexShaderSize, const char* fragmentShaderSrc, GLint fragmentShaderSize) {
    ...
    if (!success) {
        ...
        failureBox.setDetailedText(QStringLiteral(
            ...
            "%5\n")
            .arg(vertexShaderSrc)
            .arg(getShaderInfoLogAsQString(f, vertexShader))
            .arg(fragmentShaderSrc)
            .arg(getShaderInfoLogAsQString(f, fragmentShader))
            .arg(getProgramInfoLogAsQString(f, program))
        );
...
GLuint readShaders(QOpenGLFunctions_2_1* f, const QString& vertexShaderPath, const QString& fragmentShaderPath) {
